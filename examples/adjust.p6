...
if $option == 1 {
	...
	$tools.modify_color_modifier_brightness($value);
}
...
if $option == 2 {
	...
	$tools.modify_color_modifier_contrast($value);
}
...
if $option == 3 {
	...
	$tools.modify_color_modifier_gamma($value);
}
...
$tools.save_image("images/test_adjust.png");
