...
lives_ok { $tools.image_set_irrelevant_format(True); }, 'image_set_irrelevant_format is set to True';
lives_ok { $tools.image_set_irrelevant_border(True); }, 'image_set_irrelevant_border is set to True';
lives_ok { $tools.image_set_irrelevant_alpha(True); }, 'image_set_irrelevant_alpha is set to True';
...
$tools.save_image("notexist/$test_file", $error);
...
$tools.save_image($test_file, $error);
